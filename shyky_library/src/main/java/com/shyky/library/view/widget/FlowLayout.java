...
public class FlowLayout extends ViewGroup {
    ...
    public FlowLayout(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.FlowLayout);
        gravity = typedArray.getInt(R.styleable.FlowLayout_gravity, LEFT);
        typedArray.recycle();
    }
